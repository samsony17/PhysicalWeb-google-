    ...
    if (Utils.isWifiDirectDevice(item.getUrlDevice())) {
      ...
      if (!mBluetoothSite.isRunning()) {
        mBluetoothSite.connect(pwsResult.getSiteUrl(), pwsResult.getTitle());
          System.out.println(pwsResult.getSiteUrl());
      }
    } else
    {
        ...
        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://www.server1.com/104")) {

            //  String i= "104";

            bundle.putString("i", "104");
            intent.putExtras(bundle);
            startActivity(intent);
        }
        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/001")) {

            //  String i= "104";

            bundle.putString("i", "001");
            intent.putExtras(bundle);
            startActivity(intent);
        }
        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/002")) {

            //  String i= "104";

            bundle.putString("i", "002");
            intent.putExtras(bundle);
            startActivity(intent);
        } if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/003")) {

        //  String i= "104";

        bundle.putString("i", "003");
        intent.putExtras(bundle);
        startActivity(intent);
    }
        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/005")) {

            //  String i= "104";

            bundle.putString("i", "005");
            intent.putExtras(bundle);
            startActivity(intent);
        }
        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/006")) {

            //  String i= "104";

            bundle.putString("i", "006");
            intent.putExtras(bundle);
            startActivity(intent);
        }

        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/009")) {

            //  String i= "104";

            bundle.putString("i", "009");
            intent.putExtras(bundle);
            startActivity(intent);
        }
        if(pwsResult.getRequestUrl().equalsIgnoreCase( "http://server1.com/010")) {

            //  String i= "104";

            bundle.putString("i", "010");
            intent.putExtras(bundle);
            startActivity(intent);
        }

           }
       /* else if(pwsResult.getRequestUrl().equalsIgnoreCase("http://www.server1.com/104"))
           {
                Intent intent = new Intent(getActivity(),Profile2.class);
      ...
      public void run() {
        ...
        for (PwPair pwPair : mPwCollection.getGroupedPwPairsSortedByRank(
          ...
          String groupId = Utils.getGroupId(pwPair.getPwsResult());
            //String groupId = "www.server1.comserver1.com";
