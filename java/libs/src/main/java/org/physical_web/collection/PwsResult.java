...
public class PwsResult {
  ...
  public PwsResult(
    ...
    mRequestUrl = requestUrl;
      String[] nw = mRequestUrl.split("/");
    mSiteUrl = requestUrl;
    mIconUrl = (iconUrl == null || iconUrl.isEmpty()) ? null : iconUrl;
    //mTitle = (title == null || title.isEmpty()) ? null : title;
      mTitle = "Beacon " + nw[nw.length-1];
    //mDescription = (description == null || description.isEmpty()) ? null : description;
    //mGroupId = (groupId == null || groupId.isEmpty()) ? null : groupId;
      if(mRequestUrl.equalsIgnoreCase("http://www.server1.com/104")) {
          mDescription = "Yonghe liu";
      }
      if(mRequestUrl.equalsIgnoreCase( "http://server1.com/001")) {

          mDescription = "Chris Ding";
      }
      if(mRequestUrl.equalsIgnoreCase( "http://server1.com/002")) {

          mDescription = "Chengkai Li";
      } if(mRequestUrl.equalsIgnoreCase( "http://server1.com/003")) {

          mDescription = "Huang";
      }
      if(mRequestUrl.equalsIgnoreCase( "http://server1.com/005")) {

          mDescription = "Hao Che";
      }
      if(mRequestUrl.equalsIgnoreCase( "http://server1.com/006")) {

          mDescription = "";
      }

      if(mRequestUrl.equalsIgnoreCase( "http://server1.com/009")) {

          mDescription = "Jia Rao";
      }
      if(mRequestUrl.equalsIgnoreCase( "http://server1.com/010")) {
